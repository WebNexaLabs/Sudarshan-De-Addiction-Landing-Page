    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b border-primary/5 bg-white/80 dark:bg-background-dark/80 backdrop-blur-xl px-6 md:px-20 py-4 transition-all duration-300">
            <div className="mx-auto flex max-w-7xl items-center justify-between">
                <Link href="/" className="flex items-center gap-3 active:scale-95 transition-transform" aria-label="Sudarshan Recovery Center Home">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a
                        ...
                        className="hidden sm:flex items-center justify-center rounded-xl bg-primary px-6 py-2.5 text-sm font-black text-white transition-all hover:bg-primary/90 hover:scale-105 active:scale-95 shadow-lg shadow-primary/20"
                    >
                        Call Now
                    </a>
                    <button
                        aria-label="Get emergency psychiatric help"
                        className="flex items-center justify-center rounded-xl bg-red-600 px-6 py-2.5 text-sm font-black text-white shadow-xl shadow-red-600/20 transition-all hover:bg-red-700 hover:scale-105 active:scale-95"
                    >
                        Emergency
                    </button>
                </div>
