    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
            ...
            <main className="flex-1">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="flex flex-col items-center text-center gap-6 lg:gap-8">
                            ...
                            <h1 className="text-4xl md:text-7xl font-black tracking-tighter text-slate-900 dark:text-white leading-none">
                                Our Therapeutic <span className="text-primary italic">Environment</span>
                            </h1>
                            <p className="text-base md:text-xl text-slate-600 dark:text-slate-400 max-w-3xl font-medium">
                            ...
                            <div className="w-full flex overflow-x-auto pb-4 gap-3 no-scrollbar justify-start md:justify-center mt-4">
                                {categories.map((cat) => (
                                    <button
                                        key={cat}
                ...
                {/* Masonry-Style Gallery - 1 column on mobile */}
                <section className="px-6 md:px-20 py-16 lg:py-24 bg-background-light dark:bg-background-dark/50">
                    <div className="mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[300px] md:auto-rows-[250px] gap-6 lg:gap-8">
                            {galleryItems.map((item, idx) => (
                                ...
                                >
                                    ...
                                    />
                                    {/* Labels permanently visible on mobile for better accessibility */}
                                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-transparent p-10 pt-20 transition-opacity md:opacity-0 group-hover:opacity-100">
                                    ...
                                    <div className="absolute top-8 right-8">
                                        <div className="h-10 w-10 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center text-white md:opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <section className="px-6 md:px-20 py-20 lg:py-24 bg-white dark:bg-background-dark">
                    <div className="mx-auto max-w-5xl">
                        <div className="p-8 md:p-20 rounded-[3rem] bg-gradient-to-br from-primary to-blue-700 text-center text-white shadow-2xl relative overflow-hidden">
                            <div className="relative z-10 flex flex-col items-center">
                                <h2 className="text-3xl md:text-5xl font-black mb-6 lg:mb-8 leading-tight tracking-tighter">Experience Our Care <br className="hidden md:block" />In Person</h2>
                                <p className="text-base md:text-lg opacity-90 max-w-2xl mx-auto mb-10 lg:mb-12 font-medium leading-relaxed">
                            ...
                            <div className="absolute -bottom-20 -left-20 h-60 w-60 lg:h-80 lg:w-80 bg-white/10 rounded-full blur-3xl"></div>
                        </div>
                    </div>
                </section>
            </main>
